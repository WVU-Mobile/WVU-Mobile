...
enum BusRoute {
    ...
    case downtownPM
    case green
    case orange // North and South Routes + Even and Odd Hour Stops
    case gold // Even + Odd Hour Stops
    case red, tyrone, purple, cassville, blue, crown, mountainHeights, graftonRoad, pink, grey, westRun, westRunLate, blueAndGold, valleyView

    static var coords: [String:CLLocationCoordinate2D] {
        return [ "Westover Terminal" : CLLocationCoordinate2DMake(39.632401, -79.976609),
    ...
    var name: String {
        ...
        case .crown:
            return "13 - Crown"
        case .mountainHeights:
            return "14 - Mtn. Heights"
        case .graftonRoad:
            return "15 - Grafton Rd."
        case .pink:
            return "16 - Pink Line"
        case .grey:
            return "29 - Grey Line"
    ...
    var stops: [String] {
        ...
        case .blueAndGold:
            return ["Towers", "Evansdale McDonalds", "Law School Drive", "Grant and 6th", "4th Street", "Grant & 1st", "Beechurst and Campus", "Beechurst and 3rd", "Beechurst and 6th", "Beechurst and 8th", "Creative Arts Center", "Engineering Loop", "Evansdale Library", "Allen Hall"]
        case .valleyView:
            return ["Valley View", "Valley View and Chestnut Ridge", "Chestnut Ridge and Stewartstown", "Stewart Place", "Kingston and Stewart", "Stewart & Protzman", "Square at Falling Run", "University and Falling Run", "Loop Area - University Ave", "Stewart and University", "Willowdale and Junction", "Willowdale and Valley View"]
        }
    }
    ...
    var isOpen: Bool {
        ...
        case .green:
            if weekday == 7 && hour >= 9 && (hour < 17 || ( hour == 17 && minute <= 40 )){
                return true
            }
            if weekday != 1 && hour >= 8 && (hour < 17 || ( hour == 17 && minute <= 40 )){
                return true
            }
        case .gold:
            if weekday == 7 && hour >= 7 && (hour < 17 || ( hour == 17 && minute <= 10 )){
                return true
            }
            if weekday != 1 && hour >= 6 && (hour < 17 || ( hour == 17 && minute <= 10 )){
                return true
            }
        case .red:
            if weekday == 7 && (hour > 7 || ( hour == 7 && minute >= 30 )) && (hour < 15 || ( hour == 15 && minute <= 40 )){
                return true
            }
            if weekday != 1 && (hour > 6 || ( hour == 6 && minute >= 20 )) && (hour < 17 || ( hour == 17 && minute <= 10 )){
                return true
            }
        case .tyrone:
            if weekday == 7 && hour >= 8  && (hour < 17 || ( hour == 17 && minute <= 10 )){
                return true
            }
            if weekday != 1 && (hour > 6 || ( hour == 6 && minute >= 30 )) && (hour < 17 || ( hour == 17 && minute <= 10 )){
                return true
            }
        case .purple, .crown, .orange:
            if weekday != 1 && hour > 7 && (hour < 17 || ( hour == 17 && minute <= 10 )) {
                return true
            }
        case .cassville, .blue:
            if weekday == 7 && hour >= 8 && hour < 4 {
                return true
            }
            if weekday != 1 && hour >= 6 && (hour < 17 || ( hour == 17 && minute <= 10 )){
                return true
        ...
        case .mountainHeights:
            if weekday == 7 && (hour > 8 || ( hour == 8 && minute >= 5 )) && (hour < 14 || ( hour == 14 && minute <= 5 )){
                return true
            }
            if weekday != 1 && (hour > 8 || ( hour == 8 && minute >= 5 )) && (hour < 16 || ( hour == 16 && minute <= 15 )){
                return true
            }
        case .graftonRoad:
            if weekday != 1 && (hour > 9 || ( hour == 9 && minute >= 10 )) && (hour < 15 || ( hour == 15 && minute <= 5 )){
                return true
            }
        case .pink:
            if weekday == 7 && hour >= 7  && (hour < 17 || ( hour == 17 && minute <= 10 )){
            ...
            if weekday != 1 && (hour > 7 || ( hour == 7 && minute >= 40 )) && (hour < 16 || ( hour == 16 && minute <= 20 )){
                return true
            }
        case .grey:
            if hour > 6 && hour < 8 {
    ...
    var hoursString: String {
        switch self {
        case .campusPM:
            return "Thur. - Sat. 6:00 PM to 2:50 AM"
        case .downtownPM:
            return "Mon. - Sat. 6:00 PM to 12:00 AM"
        case .green:
            return "Mon. - Fri. 8:00 AM to 5:40 PM \n Sat. 9:00 AM to 5:40 PM"
        case .gold:
            return "Mon. - Fri. 6:00 AM to 5:10 PM \n Sat. 7:00 AM to 5:10 PM"
        case .red:
            return "Mon. - Fri. 6:20 AM to 5:10 PM \n Sat. 7:30 AM to 3:40 PM"
        case .tyrone:
            return "Mon. - Fri. 6:30 AM to 5:10 PM \n Sat. 8:00 AM to 5:10 PM"
        case .purple, .crown, .orange:
            return "Mon. - Sat. 7:00 AM to 5:10 PM"
        case .cassville, .blue:
            return "Mon. - Fri. 6:00 AM to 5:10 PM \n Sat. 8:00 AM to 4:00 PM"
        case .mountainHeights:
            return "Mon. - Fri. 8:05 AM to 4:15 PM \n Sat. 8:05 AM to 2:05 PM"
        case .graftonRoad:
            return "Mon. - Sat. 9:10 AM to 3:05 PM"
        case .pink:
            return "Mon. - Fri. 7:40 AM to 4:20 PM \n Sat. 7:00 AM to 5:10 PM"
        case .grey:
            return "Trip 1: Southbound 6:15 AM to Northbound 7:55 AM \n Trip 2: Southbound 12:30 PM to Northbound 5:20 PM"
        case .westRun:
            return "Mon. - Fri. 7:10 AM to 4:50 PM (Summer & Winter Breaks)\nMon. - Wed. 7:10 AM to 8:40 PM (Fall & Spring Sem.)"
        case .westRunLate:
            return "Thur. - Sat. 7:10 AM to 2:30 AM"
        case .blueAndGold:
            return "Mon. - Fri. 6:40 AM to 8:40 PM (Fall & Spring) \n Mon. - Fri. 6:40 AM to 6:20 PM (Summer) \n Sat. 3:20 PM to 7:20 PM \n Sun. 12:00 PM to 8:40 PM"
        case .valleyView:
            return "Mon. - Fri. 7:30 AM to 2:15 PM"
        }
    }
    ...
    var runTime: String {
        switch self {
        case .campusPM:
            return "Run Time: ~30 - 50 minutes"
        case .downtownPM, .cassville:
            return "Run Time: ~60 minutes"
        case .green:
            return "Run Time: ~30 minutes"
        case .orange:
            return "Run Time: ~113 minutes"
        case .gold:
            return "Run Time: ~80 minutes"
        case .red, .crown, .graftonRoad:
            return "Run Time: ~70 minutes"
        case .tyrone:
            return "Run Time: ~90 minutes"
        case .purple, .pink:
            return "Run Time: ~40 minutes"
        case .blue:
            return "Run Time: ~55 minutes"
        case .mountainHeights:
            return "Run Time: ~30 - 55 minutes"
        case .grey:
            return "Runs Twice Daily"
        case .westRun, .westRunLate:
            return "Run Time: ~20 - 30 minutes"
        case .blueAndGold:
            return "Run Time: ~20 minutes"
        case .valleyView:
            return "Run Time: ~15 minutes"
        }
    }
    ...
    var twitter: String {
        ...
        case .blue:
            return "ML12blue"
        case .mountainHeights, .graftonRoad, .crown:
            return "ML10brown"
        case .grey:
            return "ML29grey"
        case .westRun, .westRunLate:
    ...
    var semester: String? {
        switch self {
        case .campusPM:
            return "Fall and Spring Semesters Only"
        default:
            return nil
        }
    }
