...
class TransitViewController: UITableViewController {
    fileprivate static let storyboardID = "Transit"
...
extension TransitViewController {
    ...
    class var viewController: TransitViewController {
        guard let viewController = UIStoryboard(name: TransitViewController.storyboardID, bundle: nil).instantiateViewController(withIdentifier: TransitViewController.storyboardID) as? TransitViewController else {
            fatalError("View Controller with identifier '\(TransitViewController.storyboardID)' was not found.")
        }
